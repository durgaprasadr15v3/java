...
<div style="position:absolute; left:28px; top:117px; width: 687px; height: 316px;"> 
  <table width="720" height="315" align="center" bgcolor="#FFFFFF" >
    <tr> 
	    <td width="142">&nbsp;</td>
        <td width="193" height="309"><img src="images/passas.jpg" width="191" height="177"/></td>
      <td width="369"> <table width="280" align="center" >
          <form name="f" action="pass_check.jsp" method="get">
            <tr> 
              ...
              <tr> 
                <td width="124" height="39"><font color="#FFFFFF"><font color="#663333"><em><strong>old 
                  password:</strong></em></font></font></td>
              <td width="144"><input type="text" name="op" class="a" /></td>
            </tr>
            <tr> 
                <td height="57"><em><font color="#663333"><strong> new 
                  password:</strong></font></em></td>
              <td width="144"><input type="password" name="np" class="a" /></td>
            </tr>
            <tr> 
              <td height="45" colspan="2" align="center"><input type="submit" name="submit1" class="button"
		 value="Login" /></td>
            </tr>
          </form>
        </table></td>

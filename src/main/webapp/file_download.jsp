...
<div id="content"> 
 ...
 <table width="720" height="304" align="center" bgcolor="#FFFFFF" >
    ...
    <tr> 
        ...
        <td width="668"> <table width="532"  align="center"  bgcolor="#000000">
            <tr bgcolor="#333333" > 
              <td width="91" height="21" align="center"><font color="#FFFFFF" size="2">filename</font></td>
              <td width="94" align="center"><font color="#FFFFFF" size="2">fid</font></td>
              <td width="86" align="center" ><font color="#FFFFFF" size="2">size</font></td>
              <td width="100" align="center" ><font color="#FFFFFF" size="2">date</font></td>
              <td width="137" align="center" ><font color="#FFFFFF" size="2">download</font></td>
            </tr>
            <%
...
%>
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width="137" align="center"><a href="file_download1.jsp?<%=fid%>"><font color="#C60000" size="3">download</font></a></td>

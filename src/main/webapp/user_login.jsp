...
Attacks in the Cloud</em></font> 
    ...
    <ul>
      ...
      <li ><a href="register.jsp" accesskey="2" title="">signup</a></li>
      <li><a href="admin_login.jsp" accesskey="3" title="">admin</a></li>
      <li class="aa"><a href="user_login.jsp" accesskey="4" title="">user</a></li>
...
<div style="position:absolute; left:28px; top:117px; width: 687px; height: 316px;"> 
  <table width="717" height="321" align="center" bgcolor="#FFFFFF" >
    <tr> 
	    <td width="108">&nbsp;</td>
      <td width="175" height="309"><img src="images/user2.jpg" width="169" height="156"/></td>
      <td width="418" align="left"> <table width="227" align="center" >
          <form name="f" action="user_check.jsp" method="get">
            <tr> 
